...
# does not cause extreme divergence from signalized UXsim standard behavior on a
# 6x6 grid with ~1000 vehicles, where multiple routes and UXsim route choice may apply.
#
...
def build_world(control_mode, vehicle_plans):
    W = World(
        name=f"fcfs_vs_signalized_grid_{control_mode}",
        deltan=1,
        tmax=TMAX,
        print_mode=0,
        save_mode=0,
...
def test_fcfs_clearance_zero_vs_signalized_uxsim_standard_grid_network():
    ...
    print("FCFS clearance=0 vs signalized UXsim standard grid network test passed.")


if __name__ == "__main__":
    test_fcfs_clearance_zero_vs_signalized_uxsim_standard_grid_network()
