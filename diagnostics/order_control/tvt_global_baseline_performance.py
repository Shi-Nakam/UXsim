...
#
# Baseline performance probe for TVT global-World virtual computation research.
# Measures World.copy() plus normal exec_simulation() on a copied World.
# Does NOT reproduce TVT institutional logic, confirmed-rank blocks, baseline
# arrival/passage recording, or unresolved-rate measurement.
# Measures baseline performance on the existing Analyzer-attached path.
# Keeps world_state_branching_investigation.py unchanged as the prior probe.
# Global-World baseline predictions may later be reused for BATCH candidate
# selection improvement, but BATCH changes are out of scope here.
#
...
def main():
    ...
    try:
        ...
        print("=" * 72)
        print("TVT global-World baseline performance probe")
        print("=" * 72)
        print(
